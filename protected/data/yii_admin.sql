...
(1, 'admin', 'f33bdbb7ae53b09f19061c1a70ae15b3', '5b8fad', 'admin@qq.com', 'hehefg', 1370570998, 1376622494, 0, 0, 5, 1376622494, 2130706433),
(3, 'xuzhenjun', 'bc0b06b7b5947d0bdbe18a7fe68f8a4c', '6a4a68', 'hello@qq.com', 'fdsddds', 1370588383, 1376622323, 0, 0, 1, 1376622323, 2130706433);
...
CREATE TABLE IF NOT EXISTS `tb_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='后台菜单' AUTO_INCREMENT=22 ;
...
('SettingAdministrating', 'SettingUpload'),
('SettingAdministrating', 'SettingView'),
('普通管理员', 'SiteAdministrating'),
('超级管理员', 'SiteAdministrating'),
('SiteAdministrating', 'SiteIndex'),
('SiteAdministrating', 'SiteMain'),
('SiteAdministrating', 'SitePage'),
('Authority', 'srbac@AuthitemAdministrating'),
('超级管理员', 'srbac@AuthitemAdministrating'),
